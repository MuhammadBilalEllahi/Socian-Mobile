          ...
          gradient: Theme.of(context).brightness == Brightness.dark
              ...
              : LinearGradient(
                  ...
                  colors: [
                    ...
                    const Color.fromARGB(255, 32, 32, 32).withValues(alpha: 0.1)
                  ],
                ),
          border: Border.all(
            color: const Color.fromARGB(255, 22, 22, 22).withValues(alpha: 0.5),
            width: 1.5,
          ),
          boxShadow: [
            BoxShadow(
              color:
                  const Color.fromARGB(255, 31, 31, 31).withValues(alpha: 0.2),
              blurRadius: 10,
              spreadRadius: 2,
