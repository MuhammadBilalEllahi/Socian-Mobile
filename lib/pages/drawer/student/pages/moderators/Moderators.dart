  ...
  Widget _buildModeratorCard(Map<String, dynamic> moderator, bool isCurrent) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isDark ? const Color(0xFF27272A) : const Color(0xFFE0E0E0),
          width: 1,
        ),
      ),
      child: Column(
        ...
        children: [
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Icon(
                        Icons.person,
                        size: 30,
                        color: isDark ? const Color(0xFFA1A1AA) : const Color(0xFF999999),
                      );
                    },
                  ),
                ),
                    ...
                    Row(
                      children: [
                        Text(
                          name,
                          style: TextStyle(
                            color: isDark ? const Color(0xFFFAFAFA) : const Color(0xFF000000),
                            fontSize: 18,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: isCurrent
                        ? const Color(0xFFFACC15)
                        : (isDark ? const Color(0xFF71717A) : const Color(0xFF999999)),
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                  ),
                ),
          ...
          Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              color: isDark ? const Color(0xFF18181B) : const Color(0xFFF5F5F5),
              borderRadius: BorderRadius.circular(8),
              border: Border.all(
                color: isDark ? const Color(0xFF27272A) : const Color(0xFFE0E0E0),
                width: 1,
      ...
      child: Column(
        ...
        children: [
          Icon(
            icon,
            size: 64,
            color: isDark ? const Color(0xFF71717A) : const Color(0xFF999999),
          ),
          const SizedBox(height: 16),
          Text(
            message,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          controller: _tabController,
          labelColor: const Color(0xFFFACC15),
          unselectedLabelColor: isDark ? const Color(0xFFA1A1AA) : const Color(0xFF666666),
          indicatorColor: const Color(0xFFFACC15),
          tabs: [
            Tab(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.person, size: 16, color: isDark ? const Color(0xFFA1A1AA) : const Color(0xFF666666)),
                  const SizedBox(width: 8),
                  Text('Current (${currentModerators.length})'),
                ],
              ),
            ...
            Tab(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.history, size: 16, color: isDark ? const Color(0xFFA1A1AA) : const Color(0xFF666666)),
                  const SizedBox(width: 8),
                  Text('Previous (${previousModerators.length})'),
                ],
              ),
